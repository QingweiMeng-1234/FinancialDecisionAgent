    ...
    *,
    ...
    try:
        if "demand_pressure" in dimensions:
            results["demand_pressure"] = score_demand_pressure(
                **payload["demand_pressure"]
            )
        if "downstream_criticality" in dimensions:
            downstream = payload["downstream_criticality"]
            results["downstream_criticality"] = score_downstream_criticality(
        ...
        if "effective_supply_concentration" in dimensions:
            ...
            results["effective_supply_concentration"] = score_effective_supply_concentration(
                suppliers=tuple(
        ...
        if "qualification_barrier" in dimensions:
            ...
            results["qualification_barrier"] = score_qualification_barrier(
        ...
        if "capacity_inelasticity" in dimensions:
            ...
            results["capacity_inelasticity"] = score_capacity_inelasticity(
        ...
        if "substitute_weakness" in dimensions:
            ...
            results["substitute_weakness"] = score_substitute_weakness(
